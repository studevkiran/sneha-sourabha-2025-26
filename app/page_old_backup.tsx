  ...
  <header className="text-center mb-4 sm:mb-6 md:mb-8 lg:mb-10 animate-fade-in">
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6 md:gap-8 mb-5 sm:mb-7 md:mb-8">
            ...
            <div className="relative group">
              <div className="absolute inset-0 bg-gradient-to-r from-fuchsia-500/25 to-amber-400/25 rounded-2xl blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
              <div className="relative bg-gradient-to-br from-white/10 to-white/5 p-[3px] sm:p-1 rounded-2xl ring-1 ring-white/15 group-hover:ring-amber-300/30 transition-all duration-300">
        ...
        <div className="max-w-6xl mx-auto text-center mb-8 sm:mb-12 md:mb-14 lg:mb-16 animate-scale-in">
          ...
          {/* Register Button - Directly Below Title */}
          {/* Unified Action Panel - Vertical Rectangle */}
          <div className="mx-auto max-w-md sm:max-w-lg md:max-w-xl lg:max-w-2xl px-3 sm:px-4 md:px-6 mb-6 sm:mb-8 md:mb-10 animate-fade-in" style={{ animationDelay: "0.15s" }}>
            <div className="panel-border relative rounded-2xl p-[1.5px] has-sheen">
              <div className="panel-surface relative rounded-2xl backdrop-blur-md border">
                <div className="flex flex-col divide-y divide-white/10">
                  ...
                  {/* Register - Top Section with Tagline */}
                  <div className="px-5 sm:px-6 py-4 sm:py-5 flex flex-col items-center justify-center gap-3 sm:gap-3.5">
                    ...
                    <Link href="/register/type" className="group vibrant-button overflow-hidden">
                      {/* Shimmer */}
                      ...
                      <span className="relative z-10 text-sm sm:text-base md:text-lg font-bold tracking-tight">Register Now</span>
                    </Link>
                  </div>
            ...
            <div className="panel-border relative rounded-2xl p-[1.5px] has-sheen">
              <div className="panel-surface relative rounded-2xl backdrop-blur-md border">
                <div className="px-5 sm:px-7 md:px-8 py-5 sm:py-7 md:py-8">
                  ...
                  <ol className="list-decimal list-inside text-white/90 text-sm sm:text-base leading-relaxed space-y-2 sm:space-y-2.5 md:space-y-3">
                    <li>Select your registration type (Rotarian, Spouse, Ann, Annet, Guest, or Sponsorship tier).</li>
                    <li>Fill in participant details: Full Name, Mobile (10 digits), Email, Club Name, and Meal Preference.</li>
                    <li>Review the fee amount and proceed to payment; UPI is recommended for faster confirmation.</li>
                    <li>Complete the payment and note the UPI Reference/Transaction ID.</li>
                    <li>Upload the payment proof (screenshot or PDF) and enter the Transaction/UPI ID.</li>
                    <li>Submit the form to receive your Registration ID on the success page.</li>
                    <li>We will verify your payment within 24–48 hours; you’ll get a confirmation update.</li>
                    <li>Bring a valid ID and your Registration ID to the venue registration desk.</li>
                  </ol>
                  <div className="mt-4 sm:mt-5 text-[12px] sm:text-xs text-white/60">
                    Need help? Write to <span className="text-white/85">support@snehasourabha.in</span> or contact your Club coordinator.
                  </div>
                </div>
              </div>
            </div>
